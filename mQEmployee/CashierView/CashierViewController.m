...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if ([_lblCustomer.text isEqualToString:@""]) {
        _btnGetBill.enabled=NO;
    }
    else
    {
        _btnGetBill.enabled=YES;
    }
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
{
    CustomerBillPageViewController *customerBill = [[CustomerBillPageViewController alloc]initWithNibName:@"CustomerBillPageViewController" bundle:nil userName:_lblCustomer.text];

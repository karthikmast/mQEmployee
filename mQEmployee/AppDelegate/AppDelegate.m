...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _empLoginVC = [[EmployeeLoginViewController alloc] initWithNibName:@"EmployeeLoginViewController" bundle:[NSBundle mainBundle]];
    _navigationController = [[UINavigationController alloc] initWithRootViewController:_empLoginVC];
